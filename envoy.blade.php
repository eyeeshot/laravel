...
@setup
  $path = [
    'base' => '/home/blog.eyeeshot.com/web',
    'docroot' => '/home/blog.eyeeshot.com/web/envoy.appkr.kr',
    'shared' => '/home/blog.eyeeshot.com/web/shared',
    'release' => '/home/blog.eyeeshot.com/web/releases',
  ];
  ...
  $shared_item = [
    '/home/blog.eyeeshot.com/web/shared/.env' => '.env',
    '/home/blog.eyeeshot.com/web/shared/storage' => 'storage',
    '/home/blog.eyeeshot.com/web/shared/cache' => 'cache',
  ];
  ...
  $git = [
    'repo' => 'git@github.com:eyeeshot/laravel.git',
  ];
@endsetup
